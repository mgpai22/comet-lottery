...
class OutBoxes(ctx: BlockchainContext) {
  ...
  def ticketPayoutBox(
      collectionContract: ErgoContract,
      comet: ErgoToken,
      version: Long,
      counter: Long,
      timeStamp: Long,
  ...
  def firstWinnerContractBox(
      issuerBox: ErgoBox,
      winnerSelectionContract: ErgoContract,
      ticketContract: ErgoContract,
      collectionContract: ErgoContract,
      singleton: ErgoToken,
      comet: ErgoToken,
    ...
    def buildLongColl(long1: java.lang.Long, long2: java.lang.Long): String = {
      ...
      val myColl: Coll[java.lang.Long] =
        special.collection.Builder.DefaultCollBuilder.fromArray(list)
      val typ: ErgoType[Coll[java.lang.Long]] =
    ...
    this.txBuilder
      ...
      .registers(
        ErgoValue.of(ticketContract.toAddress.asP2S.scriptBytes),
        ErgoValue.of(collectionContract.toAddress.asP2S.scriptBytes),
        ErgoValue.of(distributionAddress.getPublicKey),
  ...
  def loserOutBox(
    ...
    val box1 = this.txBuilder
      .outBoxBuilder()
      .value(minAmount)
      .tokens(singleton)
      .registers(
        ErgoValue.of(version),
        ErgoValue.of(newIndex),
        ErgoValue.of(distributionAddress.getPublicKey),
        ErgoValue.of(timeStamp),
        ErgoValue.of(comet.getValue)
      )
      .contract(ticketContract)
      .build()

    val box2 = this.txBuilder
      .outBoxBuilder()
      .value(minAmount)
      .tokens(comet)
      .registers(
  ...
  def lotteryWinnerBox(
      cometWinner: ErgoToken,
      issuerBox: ErgoBox,
      cometDistribution: ErgoToken,
    ...
    val box1 = this.txBuilder
      ...
      .contract(
        new ErgoTreeContract(
          winnerAddress.getErgoAddress.script,
          this.ctx.getNetworkType
        )
      )
      .build()
    ...
    val box2 = this.txBuilder
      ...
      .contract(
        new ErgoTreeContract(
          distributionAddress.getErgoAddress.script,
          this.ctx.getNetworkType
        )
      )
      .build()
