...
class TransactionHelper(
  ...
  def createToken(
    ...
    val token = outBoxObj.tokenHelper(
      inBox.get(0),
      name,
      description,
      tokenAmount,
  ...
  def initTicketContract(
    ...
    var unsignedTransaction: UnsignedTransaction = null
    val outBoxObj = new OutBoxes(this.ctx)
    val outBox = outBoxObj.initTicketContractBox(
      singleTon = ticketContractSingleton,
      contract = contract,
      distributionAddress,
      timeStamp,
      0.002
  ...
  def initCollectionContract(
    ...
    var unsignedTransaction: UnsignedTransaction = null
    val outBoxObj = new OutBoxes(this.ctx)
    val outBox = outBoxObj.initCollectionContractBox(
      comet,
      contract,
      timeStamp: Long,
